export default async function(){
  const response = [
    {type: 'warning', urgent:true, text:`Updated 1095 Poem/116 Hours Of Poetry Audiobook Uploaded To The Internet Archive. All poems joined together in a latest-first sequence, as a single 5.2GB mp3 file.`, link:{title:`Download the 5.2GB mp3 at Archive.org`, url:'https://archive.org/details/audiobook_202303'}, note:'Every once in a while I smush all the files and upload them to the Internet Archive as a kind of an Audio Book.'},
