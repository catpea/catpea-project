export default async function(){
  const response = [
    ...
    {type: 'info', urgent:true,  text:`Website upgrade, possible outages in next couple of weeks.`,  note:`Gandi the domain registrar got bought out and prices are going up. I am transferring the domain names to porkbun.com and trying to divide the text content from audio files to find better hosting companies. But there will be some bugs and outages along the way. You can bookmark the YouTube mirror to serve as backup. It is updated daily, though some fiend gave my Sea Shanties thumbs down :(`, link:{title:`YouTube Backup`, url:'https://www.youtube.com/@catpea'}},
