...
echo -ne "\n\n\n\n\n\n\n\n\n\n"
echo "1/4 - GITHUB/chapters updating chapter 09 -----------------------------------------------------------------------------------------------------"
cd dist/chapters/chapter-09;
git add .;
...
echo NOTE: If you are working on chapter 10, update PUBLISH.SH file, to publish the new data.
echo you must cd and push 10 now, not 09;
echo -ne "\n\n"
